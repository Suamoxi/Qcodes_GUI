...
class MainWindow(QMainWindow):
    ...
    def run_qcodes(self, with_plot=False):
        ...
        exp = qc.load_or_create_experiment('old_data_loading', sample_name='no_sample')
        station = qc.Station()
        ...
        if len(self.actions):
            ...
            if self.save_location != "":
                loc_provider = qc.data.location.FormatLocation(fmt = self.save_location + '/{date}/#{counter}_{name}_{time}')
